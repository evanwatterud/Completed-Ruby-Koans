...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # It combines the elements of the object it's called on based on a given symbol
    # or block. It also takes an initial value as the first parameter.
  end
  ...
  # Probably so the file closes itself. Update: Was right, the File.open do .. end
  # block handles the sandwich code without explicitly writing it.
