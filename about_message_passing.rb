...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # send came before __send__, and send can't be overriden by other send uses,
    # as send now is redefined by other classes, such as Socket.
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    # It would no longer throw a NoMethodError, like below
    #
    # NOTE:
    #
